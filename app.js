const API_URL = "https://script.google.com/macros/s/AKfycbxyhnHg356Of43JIrnWtV-Lggg77hHAaglZLi9_5lb7oTcr20LfswWGDerqEHDnSUodcw/exec"; // <-- NÃO ESQUEÇA DE COLAR A URL DE NOVO
let estadoCompras = [];
let estadoChecklist = [];
